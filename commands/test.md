...
Commit per `git-auto-commit` in CLAUDE.md Project Config (see git.md Auto-Commit): if `true`, commit without asking; otherwise ask for confirmation before this commit:
...
Commit the ledger per `git-auto-commit` in CLAUDE.md Project Config (see git.md Auto-Commit): if `true`, commit without asking; otherwise ask for confirmation before this commit:
